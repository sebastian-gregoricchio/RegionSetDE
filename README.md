# RegionSetDE — `devel-tools`

Build and check machinery for
[RegionSetDE](https://github.com/sebastian-gregoricchio/RegionSetDE).
...
[![pkgdown](https://github.com/sebastian-gregoricchio/RegionSetDE/actions/workflows/pkgdown.yaml/badge.svg?branch=devel-tools)](https://github.com/sebastian-gregoricchio/RegionSetDE/actions/workflows/pkgdown.yaml?query=branch%3Adevel-tools)
[![Codecov](https://codecov.io/gh/sebastian-gregoricchio/RegionSetDE/branch/devel-tools/graph/badge.svg)](https://app.codecov.io/gh/sebastian-gregoricchio/RegionSetDE)
...
Before opening a pull request against `main`:
    ...
    R CMD build .
    R CMD check --no-manual RegionSetDE_*.tar.gz
    BiocCheck::BiocCheck("RegionSetDE_*.tar.gz")
...
[issues tab](https://github.com/sebastian-gregoricchio/RegionSetDE/issues),
not here.
