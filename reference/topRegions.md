...
#> 6      intergenic region_03406      NA    chr12 42124500 42125499  1000
#> 7      intergenic region_02700      NA    chr12 33474500 33475499  1000
#> 8        geneBody region_00572      NA    chr12  7295412  7296411  1000
#> 9  promoterNonCpG region_01472      NA    chr12 17981162 17982161  1000
#> 10    promoterCpG region_01273      NA    chr12 15719347 15720346  1000
...
#> 6   3.180337       4.777653          2.930994           5.497549 26.92056
#> 7  -2.202950       5.128097          5.668217           4.374667 25.79674
#> 8  -2.343642       6.847950          7.432141           5.909114 25.58223
#> 9   2.864652       5.445639          3.512708           6.217038 23.21950
#> 10 -1.771521       5.933614          6.369677           5.354945 21.00985
...
#> 6                  f   1 20.39240 4.205306e-05 1.328176e-02          up
#> 7                  f   1 18.95485 6.712520e-05 1.683932e-02        down
#> 8                  f   1 18.88816 7.108947e-05 1.683932e-02        down
#> 9                  f   1 17.29784 1.531036e-04 3.223681e-02          up
#> 10                 f   1 18.87993 2.058661e-04 3.901163e-02        down
#>        regionId
#> 1  region_02996
#> 2  region_03590
#> 3  region_00212
...
#> 1 promoterCpG region_01273      NA    chr12 15719347 15720346  1000 -1.771521
#> 2 promoterCpG region_02452      NA    chr12 30097777 30098776  1000  1.513446
...
#> 1       5.933614          6.369677           5.354945 21.009851
#> 2       5.117243          3.933038           5.716098 10.076467
#> 3       5.016526          3.931088           5.594134  8.582683
#> 4       4.658080          3.519312           5.233976  7.080136
#> 5       5.879394          6.180296           5.518509  6.508768
#>   stat.distribution df1      df2      p.value        FDR diff.status
#> 1                 f   1 18.87993 0.0002058661 0.03901163        down
#> 2                 f   1 18.97783 0.0049984001 0.28702934        null
#> 3                 f   1 18.97791 0.0086069702 0.36371630        null
#> 4                 f   1 17.28329 0.0163032446 0.45433307        null
#> 5                 f   1 16.92300 0.0207077166 0.49672308        null
#>       regionId
#> 1 region_01273
#> 2 region_02452
#> 3 region_01859
...
#>       region.set    region.id tile.id seqnames    start      end width
#> 1 promoterNonCpG region_02996      NA    chr12 36842295 36843294  1000
#> 2 promoterNonCpG region_00212      NA    chr12  2500829  2501828  1000
#> 3     intergenic region_01115      NA    chr12 13844500 13845499  1000
#> 4       geneBody region_03415      NA    chr12 42209041 42210040  1000
#> 5     intergenic region_03590      NA    chr12 44174500 44175499  1000
#>      log2FC average.signal average.signal.BN average.signal.SHR      stat
#> 1 -5.203835       5.159079          6.078432           2.651961 84.136173
#> 2 -3.222630       4.816977          5.557234           3.451580 34.299774
#> 3 -3.154327       3.819372          4.514520           2.774385 15.362838
#> 4 -3.020137       3.189783          3.806558           2.388896  8.417927
#> 5 -2.887100       5.237329          5.930447           4.057310 43.045774
#>   stat.distribution df1      df2      p.value          FDR diff.status
#> 1                 f   1 20.32506 1.148685e-08 2.176757e-05        down
#> 2                 f   1 18.45056 1.370844e-05 6.573186e-03        down
#> 3                 f   1 18.35724 9.731331e-04 9.705722e-02        null
#> 4                 f   1 19.99364 8.828997e-03 3.637163e-01        null
#> 5                 f   1 19.05860 2.743053e-06 2.599042e-03        down
#>       regionId
#> 1 region_02996
#> 2 region_00212
#> 3 region_01115
